class script(object):
    START_TXT = """𝙷𝙴𝙻𝙾 {},
𝑴𝒀 𝑵𝑨𝑴𝑬 , <a href='https://t.me/Shinobufl_bot'>𝐒𝐡𝐢𝐧𝐨𝐛𝐮ᵏᵒᶜʰᵒ</a>, 𝑰𝒕'𝒔 𝑽𝒆𝒓𝒓𝒚 𝑬𝒂𝒔𝒚. 𝑱𝒖𝒂𝒕 𝑨𝒅𝒅 𝑴𝒆 𝑻𝒐 𝒀𝒐𝒖𝒓 𝑮𝒓𝒐𝒖𝒑 𝑨𝒏𝒅 𝑴𝒂𝒌𝒆 𝑴𝒆 𝑨𝒅𝒎𝒊𝒏, 𝑻𝒉𝒂𝒕𝒔 𝑨𝒍𝒍, 𝑰'𝑳𝑳 𝑷𝒓𝒐𝒗𝒊𝒅𝒆 𝑴𝑶𝑽𝑰𝑬𝑺 𝑻𝒉𝒆𝒓𝒆 🤓
...
<b>URL buttons:</b>
<code>[Button Text](buttonurl:https//t.me/Shinobufl_Bot)</code>
